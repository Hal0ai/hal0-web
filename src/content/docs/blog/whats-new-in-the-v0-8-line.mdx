...
<Aside type="note" title="Historical release notes">
This post covers the v0.8 beta line and predates 1.0.0. See the
[changelog](/changelog) for the current release, and the
[full changelog](/changelog#v0.8.4b1) for the v0.8.4b1 entry.
</Aside>
...
[changelog](/changelog#v0.8.0-beta.1).
...
v0.9 took everything landed across these betas and stabilized it into the
next line; 1.0.0 followed. See the [changelog](/changelog) for what shipped
since.
