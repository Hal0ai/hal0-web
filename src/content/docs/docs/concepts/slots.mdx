...
callers keep working: `agent-hermes` resolves to `agent`. Aliases are never
written to disk and never appear in slot listings — they're a transparent
translation at dispatch time.
