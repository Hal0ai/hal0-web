...
|---|---|---|
| `rocm-dnse` | GPU (ROCm) | Dense models with MTP speculative decoding |
| `rocm-moe` | GPU (ROCm) | MoE models with MTP speculative decoding |
...
![The Profiles tab in the hal0 dashboard showing seed profile cards for rocm-dnse, rocm-moe, vulkan, flm, tts, and comfyui with bench metrics and device class chips](/screenshots/profiles-tab.png)
