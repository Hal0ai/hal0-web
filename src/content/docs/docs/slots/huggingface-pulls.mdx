...
`POST /api/models/{id}/pull` is **not yet implemented** in v1 — it
...
This is one of the remaining v1.0-cut gaps tracked in the
[roadmap](/roadmap/). When it lands, this page will be updated with
the live API shape, retry semantics, and disk-space pre-flight
behaviour.
